...
function Ventas(props: { hide: boolean }) {
    ...
    const [buscandoFP, setBuscandoFP] = useState<boolean>(false);
    const [buscandoArticulos, setBuscandoArticulos] = useState<boolean>(false);
                        ...
                        <div className="overflow-x-auto rounded-lg border border-gray-200">
                            <table className="w-full min-w-[600px]">
                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {buscandoArticulos ? <tr><td><b>Buscando...</b></td></tr> :
                                        <>
                            ...
                            <tbody className="divide-y divide-gray-200">
                                ...
                                {buscandoFP ?
                                    ...
                                    : <tr className="bg-green-100 font-bold">
                                        <td className="px-4 py-3 text-blue-900 border-t border-gray-200 text-2xl">Totale</td>
